...
<head>
	<title>Admin Paneline Hoş Geldiniz</title>
	<meta charset="utf-8">
	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="admin_dashboard.php" class="active"><i class="lnr lnr-home"></i> <span>Pano</span></a></li>
						<li><a href="state.php" class=""><i class="lnr lnr-code"></i> <span>İl</span></a></li>
						<li><a href="city.php" class=""><i class="lnr lnr-chart-bars"></i> <span>İlçe</span></a></li>
						<li><a href="members.php" class=""><i class="lnr lnr-cog"></i> <span>Üyeler</span></a></li>
						<li><a href="donor.php" class=""><i class="lnr lnr-alarm"></i> <span>Aktif Olmayan Bağışçılar</span></a></li>
						<li><a href="active_donors.php" class=""><i class="lnr lnr-alarm"></i> <span>Aktif Bağışçılar</span></a></li>
